...
<script>
import {
  mdiArrowLeft, mdiArrowRight, mdiChevronLeft, mdiChevronRight, mdiAlertCircleOutline,
} from '@mdi/js'
...
export default {
  ...
  methods: {
    async onSend() {
      if (this.client.name !== null && this.client.phone !== null && this.client.address !== null) {
        this.isLoading = true
        await axios
